...
---
name: deploy
description: "Deploy the application to production, when explicitly asked to deploy."
...
---
name: pdf-processing
description: "Extract PDF text, fill forms, merge files, when handling PDFs."
license: Apache-2.0
...
```yaml
"[What the skill does], when [specific contexts, including non-obvious ones]. Triggers on: [keyword1], [keyword2], [keyword3]."
```
